...
* Есть возможность редактировать уже сохраненную задачу, достаточно выбрать ее из списка в режиме редактирования.  
* Уже ненужную задачу можно удалить, нажав del, выделив перед этим ее в списке одинарным кликом."""
